...
export default function LoginPage() {
  ...
  const styles = `
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .demo-account { display: flex; justify-content: space-between; align-items: center; padding: 8px 0; border-bottom: 1px solid #e2e8f0; }
    .demo-account:last-child { border-bottom: none; }
    .demo-role { font-weight: 600; color: #334155; font-size: 13px; }
    .demo-email { color: #64748b; font-size: 12px; }
    .demo-btn { padding: 6px 12px; background: #e2e8f0; border: none; border-radius: 6px; color: #475569; font-size: 11px; font-weight: 600; cursor: pointer; font-family: inherit; }
